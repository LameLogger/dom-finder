...
greetings(){
echo "
`tput setaf 5`i welcome you`tput setaf 1` $USER! `tput sgr0` You are using `tput setaf 6` DOM FINDER `tput sgr0` coded by `tput setaf 3` anonymous `tput sgr0`" 
...
{
echo " `tput sgr0` ==== `tput setaf 3` Process Completed!. Thank you for using `tput sgr0` `tput setaf 6` DOM FINDER`tput sgr0` ===="
}
step1()
{
